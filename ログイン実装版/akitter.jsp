...
<div id="akiadu_header">
    <h id="akiadu_top" style="top: 4px; left: 260px;">クライアントで差をつけろ(Akitter)</h>
</div>
<div id="akiadu_back"></div>
<div id="akiadu_contents">
    <h2 id="akiadu_title" style=" top: 130px; left: 260px;">概要 </h2>
    <p id="akiadu_content" style="top: 185px; left: 260px;">Akitterは他に類を見ないPC用Twitterクライアントになっております。<br>色々とアレがアレで多くは語れないのでとりあえず使ってみよう。<br>君は今までにない世界を経験し驚愕するだろう。
    </p>
    ...
    <p id="akiadu_content" style="top: 525px; left: 260px;"><a href="https://twitter.com/akiirokoutya">こちら</a>&nbsp;&nbsp;(作者Twitterに接続するので頑張って貰ってください。)<br>動作環境：Windows7,8,10(32bit/64bit)
    </p>
